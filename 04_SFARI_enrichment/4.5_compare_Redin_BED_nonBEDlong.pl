#! /usr/local/perl -w
#Total-Redin: 74	 Total-mouse: 37362	 Total-mouse-unique-symbols: 37201	 Redin-Mouse-both-exists: 74	 Redin-no-mouse-gene: 
#BED-gene:         185	Redin-overlap-BED-gene:        8
#nonBEDlong-gene:         4905	Redin-overlap-nonBEDlong-gene:        23

# fisher.test(matrix(c(8,185-8,23,4905-23),ncol=2),alternative="greater") # p-value = 1.007e-05
...
open(INB,"ASD_associated_genes_Redin.txt")||die("Can't open INF:$!\n");
...
print "Total-Redin: $sfari_gene\t Total-mouse: $mouse_gene\t Total-mouse-unique-symbols: $mouse_gene2\t Redin-Mouse-both-exists: $sfari_mouse\t Redin-no-mouse-gene: $sfari_nomouse\n";
print "BED-gene:         $a1\tRedin-overlap-BED-gene:        $a2\n";
print "nonBEDlong-gene:         $a3\tRedin-overlap-nonBEDlong-gene:        $a4\n";
