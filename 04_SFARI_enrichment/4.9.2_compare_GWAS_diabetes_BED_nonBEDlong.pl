...
#Total-GWAS_Catalog_EBI_diabetes: 1125-2	 Total-mouse: 37362	 Total-mouse-unique-symbols: 37201	 diabetes-Mouse-both-exists: 868	 diabetes-no-mouse-gene: 257
#BED-gene:         185	diabetes-overlap-BED-gene:        27
#nonBEDlong-gene:         185	diabetes-overlap-nonBEDlong-gene:        22

# fisher.test(matrix(c(27,185-27,22,185-22),ncol=2),alternative="greater") #  p-value = 0.2699
...
open(INB,"GWAS_Catalog_EBI_diabetes.txt")||die("Can't open INF:$!\n");
...
print "Total-GWAS_Catalog_EBI_diabetes: $sfari_gene\t Total-mouse: $mouse_gene\t Total-mouse-unique-symbols: $mouse_gene2\t diabetes-Mouse-both-exists: $sfari_mouse\t diabetes-no-mouse-gene: $sfari_nomouse\n";
print "BED-gene:         $a1\tdiabetes-overlap-BED-gene:        $a2\n";
print "nonBEDlong-gene:         $a3\tdiabetes-overlap-nonBEDlong-gene:        $a4\n";
