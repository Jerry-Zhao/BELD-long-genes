#! /usr/local/perl -w
#Total-Lek: 1803	 Total-mouse: 37362	 Total-mouse-unique-symbols: 37201	 Lek-Mouse-both-exists: 1745	 Lek-no-mouse-gene: 58
#BED-gene:         185	Lek-overlap-BED-gene:        84
#nonBEDlong-gene:         4905	Lek-overlap-nonBEDlong-gene:        775

# fisher.test(matrix(c(84,185-84,775,4905-775),ncol=2),alternative="greater") #  p-value < 2.2e-16
...
open(INB,"Highly_constrained_genes_1803_Lek.txt")||die("Can't open INF:$!\n");
...
print "Total-Lek: $sfari_gene\t Total-mouse: $mouse_gene\t Total-mouse-unique-symbols: $mouse_gene2\t Lek-Mouse-both-exists: $sfari_mouse\t Lek-no-mouse-gene: $sfari_nomouse\n";
print "BED-gene:         $a1\tLek-overlap-BED-gene:        $a2\n";
print "nonBEDlong-gene:         $a3\tLek-overlap-nonBEDlong-gene:        $a4\n";
