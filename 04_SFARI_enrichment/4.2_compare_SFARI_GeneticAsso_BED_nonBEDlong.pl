#! /usr/local/perl -w
#BED-gene:         185	SFARI-overlap-BED-gene:        15
#nonBEDlong-gene:         185	SFARI-overlap-nonBEDlong-gene:        9
# fisher.test(matrix(c(15,185-15,9,185-9),ncol=2),alternative="greater") # p-value = 0.1456
...
open(INB,"SFARI_791genes_20160126_Genetic_Association.csv")||die("Can't open INF:$!\n");
