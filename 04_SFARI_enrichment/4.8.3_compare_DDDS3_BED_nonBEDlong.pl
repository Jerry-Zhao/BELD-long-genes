#! /usr/local/perl -w
#Total-DDDS3: 93	 Total-mouse: 37362	 Total-mouse-unique-symbols: 37201	 DDDS3-Mouse-both-exists: 93	 DDDS3-no-mouse-gene: 
#BED-gene:         185	DDDS3-overlap-BED-gene:        13
#nonBEDlong-gene:         185	DDDS3-overlap-nonBEDlong-gene:        5

# fisher.test(matrix(c(13,185-13,5,185-5),ncol=2),alternative="greater") # p-value = 0.0441
...
open(INB,"DDD_TableS3_93genes.txt")||die("Can't open INF:$!\n");
...
print "Total-DDDS3: $sfari_gene\t Total-mouse: $mouse_gene\t Total-mouse-unique-symbols: $mouse_gene2\t DDDS3-Mouse-both-exists: $sfari_mouse\t DDDS3-no-mouse-gene: $sfari_nomouse\n";
print "BED-gene:         $a1\tDDDS3-overlap-BED-gene:        $a2\n";
print "nonBEDlong-gene:         $a3\tDDDS3-overlap-nonBEDlong-gene:        $a4\n";
