#! /usr/local/perl -w
#Total-DeRubeis: 107	 Total-mouse: 37362	 Total-mouse-unique-symbols: 37201	 DeRubeis-Mouse-both-exists: 98	 DeRubeis-no-mouse-gene: 9
#BED-gene:         185	DeRubeis-overlap-BED-gene:        7
#nonBEDlong-gene:         4905	DeRubeis-overlap-nonBEDlong-gene:        31

# fisher.test(matrix(c(7,185-7,31,4905-31),ncol=2),alternative="greater") # p-value = 0.0003626
...
open(INB,"ASD_associated_genes_DeRubeis.txt")||die("Can't open INF:$!\n");
...
print "Total-DeRubeis: $sfari_gene\t Total-mouse: $mouse_gene\t Total-mouse-unique-symbols: $mouse_gene2\t DeRubeis-Mouse-both-exists: $sfari_mouse\t DeRubeis-no-mouse-gene: $sfari_nomouse\n";
print "BED-gene:         $a1\tDeRubeis-overlap-BED-gene:        $a2\n";
print "nonBEDlong-gene:         $a3\tDeRubeis-overlap-nonBEDlong-gene:        $a4\n";
