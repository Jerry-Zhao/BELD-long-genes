#! /usr/local/perl -w
#Total-DDDS4: 707	 Total-mouse: 37362	 Total-mouse-unique-symbols: 37201	 DDDS4-Mouse-both-exists: 674	 DDDS4-no-mouse-gene: 33
#BED-gene:         185	DDDS4-overlap-BED-gene:        22
#nonBEDlong-gene:         185	DDDS4-overlap-nonBEDlong-gene:        21

# fisher.test(matrix(c(22,185-22,21,185-21),ncol=2),alternative="greater") # p-value = 0.5
...
open(INB,"ID_707genes_Lelieveld.txt")||die("Can't open INF:$!\n");
...
print "Total-DDDS4: $sfari_gene\t Total-mouse: $mouse_gene\t Total-mouse-unique-symbols: $mouse_gene2\t DDDS4-Mouse-both-exists: $sfari_mouse\t DDDS4-no-mouse-gene: $sfari_nomouse\n";
print "BED-gene:         $a1\tDDDS4-overlap-BED-gene:        $a2\n";
print "nonBEDlong-gene:         $a3\tDDDS4-overlap-nonBEDlong-gene:        $a4\n";
