#! /usr/local/perl -w
#Total-Sanders: 65	 Total-mouse: 37362	 Total-mouse-unique-symbols: 37201	 Sanders-Mouse-both-exists: 64	 Sanders-no-mouse-gene: 1
#BED-gene:         185	Sanders-overlap-BED-gene:        9
#nonBEDlong-gene:         4905	Sanders-overlap-nonBEDlong-gene:        23

# fisher.test(matrix(c(9,185-9,23,4905-23),ncol=2),alternative="greater") # p-value = 1.24e-06
...
open(INB,"ASD_associated_genes_Sanders.txt")||die("Can't open INF:$!\n");
...
print "Total-Sanders: $sfari_gene\t Total-mouse: $mouse_gene\t Total-mouse-unique-symbols: $mouse_gene2\t Sanders-Mouse-both-exists: $sfari_mouse\t Sanders-no-mouse-gene: $sfari_nomouse\n";
print "BED-gene:         $a1\tSanders-overlap-BED-gene:        $a2\n";
print "nonBEDlong-gene:         $a3\tSanders-overlap-nonBEDlong-gene:        $a4\n";
