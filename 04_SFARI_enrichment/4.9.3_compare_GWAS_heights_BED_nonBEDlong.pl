...
#Total-GWAS_Catalog_EBI_heights: 610-2	 Total-mouse: 37362	 Total-mouse-unique-symbols: 37201	 heights-Mouse-both-exists: 497	 heights-no-mouse-gene: 113
#BED-gene:         185	heights-overlap-BED-gene:        12
#nonBEDlong-gene:         185	heights-overlap-nonBEDlong-gene:        16

# fisher.test(matrix(c(12,185-12,16,185-16),ncol=2),alternative="greater") #  p-value = 0.8371
...
open(INB,"GWAS_Catalog_EBI_heights.txt")||die("Can't open INF:$!\n");
...
print "Total-GWAS_Catalog_EBI_heights: $sfari_gene\t Total-mouse: $mouse_gene\t Total-mouse-unique-symbols: $mouse_gene2\t heights-Mouse-both-exists: $sfari_mouse\t heights-no-mouse-gene: $sfari_nomouse\n";
print "BED-gene:         $a1\theights-overlap-BED-gene:        $a2\n";
print "nonBEDlong-gene:         $a3\theights-overlap-nonBEDlong-gene:        $a4\n";
