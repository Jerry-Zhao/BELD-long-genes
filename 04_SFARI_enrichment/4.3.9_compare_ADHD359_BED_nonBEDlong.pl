#! /usr/local/perl -w
#Total-DDDS4: 359	 Total-mouse: 37362	 Total-mouse-unique-symbols: 37201	 DDDS4-Mouse-both-exists: 332	 DDDS4-no-mouse-gene: 27
#BED-gene:         185	DDDS4-overlap-BED-gene:        22
#nonBEDlong-gene:         185	DDDS4-overlap-nonBEDlong-gene:        11

# fisher.test(matrix(c(22,185-22,11,185-11),ncol=2),alternative="greater") # p-value = 0.0334
...
open(INB,"ADHDgene_359gene.txt")||die("Can't open INF:$!\n");
